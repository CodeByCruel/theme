                    ...
                    <tr>
                        <td>
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #191919; border-radius: 16px; border: 1px solid rgba(255,255,255,0.08); overflow: hidden;">
                                ...
                                <tr>
                                    <td style="padding: 40px 40px 0 40px;" class="mobile-padding">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="font-family: Inter, system-ui, sans-serif; font-size: 24px; font-weight: 700; color: #ffffff; text-align: center; padding-bottom: 16px;">
                                                    Password Reset
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td align="center">
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                                        <tr>
                                                            <td style="border-radius: 10px; background-color: #df3050;">
                                                                <a href="{{ $resetUrl }}" target="_blank" style="display: inline-block; padding: 14px 40px; font-family: Inter, system-ui, sans-serif; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 10px; background-color: #df3050; border: 1px solid rgba(255,255,255,0.1);">
                                                                    Reset Password
                                                                </a>
                                                            </td>
                                                        </tr>
                                ...
                                {{-- Expiry Notice --}}
                                <tr>
                                    <td style="padding: 24px 40px 40px 40px;" class="mobile-padding">
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            <tr>
                                                <td style="font-family: Inter, system-ui, sans-serif; font-size: 13px; line-height: 20px; color: #a1a1aa; text-align: center;">
                                                    This link expires in <strong style="color: #ffffff;">60 minutes</strong>. If you didn't request a password reset, you can safely ignore this email.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
