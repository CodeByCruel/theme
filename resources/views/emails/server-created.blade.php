                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                <td style="font-family: Inter, system-ui, sans-serif; font-size: 15px; line-height: 24px; color: #a1a1aa; text-align: center;">
                                                    Your new game server has been successfully provisioned and is ready to use.
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                                    ...
                                                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                                        <tr>
                                                            <td style="border-radius: 10px; background-color: #df3050;">
                                                                <a href="{{ url('/server/' . ($server->uuid ?? '')) }}" target="_blank" style="display: inline-block; padding: 14px 40px; font-family: Inter, system-ui, sans-serif; font-size: 15px; font-weight: 600; color: #ffffff; text-decoration: none; border-radius: 10px; background-color: #df3050; border: 1px solid rgba(255,255,255,0.1);">
                                                                    Manage Server
                                                                </a>
                                                            </td>
                                                        </tr>
